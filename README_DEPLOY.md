...
프론트(`index.html`, 사회 48 DAY + 국어 36 DAY + 한국사 90 DAY + 과학 36 DAY = 210 DAY·5250문제 단일파일)는 `GET /` 로 서빙되고,
로그인·프로필·점수·리더보드(전체/사회/국어/한국사/과학 탭)는 `/api/*` + MongoDB에 저장됩니다.

## 0. 사용 흐름
시작하기 → 과목 선택(📖 사회 통합사회2 / 📝 국어 공통국어2 / 🏛️ 한국사 한국사2 / 🔬 과학 통합과학2) → 대단원·난이도 선택 → DAY 풀이(25문제, 제출 후 채점·분석)
...
- 과학(천재교과서 통합과학2): Ⅰ.변화와 다양성(5) Ⅱ.환경과 에너지(5) Ⅲ.과학과 미래 사회(2) = 난이도별 12 DAY
